			...
			<li class="span3">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<h4 style="text-align:center"><!-- <a class="btn" href="{{ url('product/'.$product['id']) }}"> <i class="icon-zoom-in"></i></a> --> <a class="btn" href="#">Ekle <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">
