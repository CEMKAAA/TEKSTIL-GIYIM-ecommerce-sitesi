              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                      <label for="image">Afiş Görseli</label>
                      ...
                      <div>Tavsiye edilen görsel boyutu: Width:1170px, Height:480px)</div>
                      @if(!empty($banner['image']))
                          <div><img style="width:250px; margin-top: 15px; margin-bottom: 5px;" src="{{ asset('images/banner_images/'.$banner['image']) }}">
                          </div>
                      @endif
                      <div>
                  </div>
                  <div class="form-group">
                      <label for="link">Afiş Linki</label>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                      <label for="title">Afiş Başlığı</label>
                  ...
                  <div class="form-group">
                      <label for="alt">Afiş Alternatif Yazısı</label>
