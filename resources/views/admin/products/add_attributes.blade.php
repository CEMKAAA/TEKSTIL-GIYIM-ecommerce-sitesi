        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ürün Özellikleri</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form name="addAttributeForm" id="addAttributeForm" method="post" action="{{ url('admin/add-attributes/'.$productdata['id']) }}">@csrf
          <div class="card card-default">
              ...
              <div class="row">
                <div class="col-md-6">
                	...
                	<div class="form-group">
                      <label for="product_name">Ürün Adı:</label> &nbsp;{{ $productdata['product_name'] }}

                  </div>
                  <div class="form-group">
                      <label for="product_code">Ürün Kodu:</label> &nbsp; {{ $productdata['product_code'] }}
                  </div>
                  <div class="form-group">
                      <label for="product_color">Ürün Rengi</label> &nbsp; {{ $productdata['product_color'] }}
                  </div>
                  <div class="form-group">
                      <label for="product_color">Ürün Fiyatı</label> &nbsp; {{ $productdata['product_price'] }}
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary">Özellik Ekle</button>
            </div>
          </div>
        </form>
        ...
        <form name="editAttributeForm" id="editAttributeForm" method="post" action="{{ url('admin/edit-attributes/'.$productdata['id']) }}">@csrf
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Eklenmiş Ürün Özellikleri</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-primary">Özellikleri Güncelle</button>
              </div>
              <!-- /.card-body -->
          </div>
        </form>
