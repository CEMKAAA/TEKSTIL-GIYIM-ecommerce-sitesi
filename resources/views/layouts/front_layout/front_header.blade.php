...
<div id="header">
	<div class="container">
		<div id="welcomeLine" class="row">
			<div class="span6">Hoşgeldin!<strong> Kullanıcı</strong></div>
			<div class="span6">
				<div class="pull-right">
					<a href="product_summary.html"><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i> [ 3 ] Sepeteki Ürünler </span> </a>
				</div>
			</div>
		</div>
		<!-- Navbar ================================================== -->
		  ...
		  <div class="navbar">
		    <div class="navbar-inner">
		      <div class="container">
		        ...
		        <a class="brand" href="#">Barkod Kurulum</a>
		        <div class="nav-collapse">
		          ...
		          <ul class="nav pull-right">
		            ...
		            @else
		            	<li><a href="{{ url('login-register') }}">Giriş Yap / Kaydol</a></li>
		            @endif
		          </ul>
		        </div><!-- /.nav-collapse -->
		      </div>
